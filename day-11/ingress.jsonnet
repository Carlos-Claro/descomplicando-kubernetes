...
local kp =
  (import 'kube-prometheus/main.libsonnet') +
  {
    values+:: {
      ...
      grafana+:: {
        config+: {
          sections+: {
            server+: {
              root_url: 'http://grafana.carlosclaro.com.br/',
            },
          },
        },
      },
    ...
    alertmanager+:: {
      alertmanager+: {
        spec+: {
          externalUrl: 'http://alertmanager.carlosclaro.com.br',
        },
      },
    },
    prometheus+:: {
      prometheus+: {
        spec+: {
          externalUrl: 'http://prometheus.carlosclaro.com.br',
        },
      },
    },
    ...
    ingress+:: {
      'alertmanager-main': ingress(
        ...
        [{
          host: 'alertmanager.carlosclaro.com.br',
          http: {
            paths: [{
              path: '/',
              pathType: 'Prefix',
      ...
      'prometheus-k8s': ingress(
        ...
        $.values.common.namespace,
        [{
          host: 'prometheus.carlosclaro.com.br',
          http: {
            paths: [{
              path: '/',
              pathType: 'Prefix',
